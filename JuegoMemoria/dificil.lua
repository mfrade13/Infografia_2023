...
local function actualizarTiempo()
    ...
    if tiempo==tiempoInicial and not perdedor then
        ...
        local txtperdiste = display.newText( "Perdiste", display.contentCenterX, btnperdiste.y , "Consolas", 24)
        ...
        if seleccionada == nil then
            ...
            if tarjeta.contenido == seleccionada.contenido then
                ...
                if giradas == filas * columnas then
                    ...
                    local txtganador = display.newText( "Ganaste", display.contentCenterX, btnganador.y , "Consolas", 24)
